...
def my_calc_stacked_endnodes(data, distances, settings):
    ...
    nodes_stacked = {
        ...
        'way_ID': np.ceil(nodes_stacked_indices_unique / 2).astype(int),
        'endnode1': nodes_stacked_indices_unique % 2
    }
    ...
    for i_ways in range(len(data)):
        ...
        if i_ways + 1 == nodes_stacked['way_ID'][i_stacked_nodes]: # MATLAB index starts at 1

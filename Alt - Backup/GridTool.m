...
simple_data_to_txt(data_ways_selected, 'data_ways_selected_final_coordinates_matlab.txt')                                   
...
function [] = simple_data_to_txt(data_ways_analyze, fileName)
    ...
    for i = 1:length(data_ways_analyze)
        ...
        fprintf(fileID, '%d, %f, %f, %f, %f, %d, %f, %f, %f, %f\n', ce.ID_node1_final, ce.lon1_final, ce.lat1_final, ...
            ce.x1_final, ce.y1_final, ce.ID_node2_final, ce.lon2_final, ce.lat2_final, ce.x2_final, ce.y2_final);
